package src.com.java.main.start;
...
public class AppRun {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        rs1.close();
        while (true) {
            System.out.println("请输入选择：1.登录 2注册  3管理员登录   4关闭");
    ...
    private static void Register(ArrayList<User> list) throws SQLException, ClassNotFoundException {
        while (true) {
            ...
            if (flag) {
                ...
                //输入的用户名不符合
                System.out.println("用户名要求4-10位且全为字母，请重新输入");
            }
        }
    }
